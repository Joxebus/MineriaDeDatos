...
<body>
<a href="#create-configuracion" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-configuracion" class="content scaffold-create" role="main">
    ...
    <g:hasErrors bean="${configuracionInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${configuracionInstance}" var="error">
